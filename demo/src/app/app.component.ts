...
import { GoogleChartInterface } from "../../../src/google-charts-interfaces";
import { ChartSelectEvent } from "../../../src/google-chart/chart-select-event";
import { RegionClickEvent } from "../../../src/google-chart/geochart-events";
import { ChartReadyEvent } from "../../../src/google-chart/chart-ready-event";
import { ChartErrorEvent } from "../../../src/google-chart/chart-error-event";
import {
  ChartMouseOverEvent,
  ChartMouseOutEvent
} from "../../../src/google-chart/chart-mouse-event";
...
export class AppComponent {
  ...
  ngOnInit() {
    ...
    this.treeMap.dataTable = this.treeMap.dataTable.concat(
      shakespeareData[this.treeMapAppendCount++]
    );
  }
  ...
  public setupTooltips() {
    ...
    for (let i = 0; i < this.columnChartWTooltips.dataTable.length - 1; i++) {
      ...
      const el = google.visualization.events.addListener(
        tooltipChart,
        "ready",
        () => {
  ...
  public openAsPNG() {
    this.imageURI = this.columnChart2.component.wrapper
      .getChart()
      .getImageURI();
    $("#exampleModal").modal();
  }
